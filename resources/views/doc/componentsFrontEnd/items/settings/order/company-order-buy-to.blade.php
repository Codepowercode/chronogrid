<div class="content-page">
    <hr>
    <div class="content">
        <div class="overflow-hidden content-section" id="company-order-buy-to-get-started">
            <h1>Order buy to</h1>
            <p>
                Company order buy to API options
            </p>
        </div>
        <div class="overflow-hidden content-section" id="company-order-buy-to-get-characters">
            <h2><span class="request-method">get</span> method</h2>
            <p>
                <code class="higlighted break-word">https://app.chronogrid.com/api/settings/orders/buy/to</code>
            </p>
            <br>
        ...
        <div class="overflow-hidden content-section" id="company-order-buy-to-response">
            ...
            <pre><code class="json" style="border:1px solid grey">
{
    ...
    "orders": [
        ...
        <div class="overflow-hidden content-section" id="company-order-buy-to-errors">
            <h2>Errors</h2>
{{--            <p>--}}
