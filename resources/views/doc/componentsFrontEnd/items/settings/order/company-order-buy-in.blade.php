<div class="content-page">
    <hr>
    <div class="content">
        <div class="overflow-hidden content-section" id="company-order-buy-in-get-started">
            <h1>Order buy in</h1>
            <p>
                Company order buy in API options
            </p>
        </div>
        <div class="overflow-hidden content-section" id="company-order-buy-in-get-characters">
            <h2><span class="request-method">get</span> method</h2>
            <p>
                <code class="higlighted break-word">https://app.chronogrid.com/api/settings/orders/buy/in</code>
            </p>
            <br>
        ...
        <div class="overflow-hidden content-section" id="company-order-buy-in-response">
            ...
            <pre><code class="json" style="border:1px solid grey">
{
    ...
    "orders": [
        ...
        <div class="overflow-hidden content-section" id="company-order-buy-in-errors">
            <h2>Errors</h2>
{{--            <p>--}}
