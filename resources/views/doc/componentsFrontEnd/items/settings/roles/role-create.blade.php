<div class="content-page">
    <hr>
    <div class="content">
        <div class="overflow-hidden content-section" id="role-create-get-started">
            <h1>Create role</h1>
            <p>
                Create role API options
            </p>
        </div>
        <div class="overflow-hidden content-section" id="role-create-get-characters">
            <h2><span class="request-method">post</span> method</h2>
            <p>
                <code class="higlighted break-word">https://app.chronogrid.com/api/settings/role/create</code>
            </p>
            <br>
