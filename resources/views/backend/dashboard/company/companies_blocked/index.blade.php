                                    ...
                                    <tbody>
                                        @foreach($companies as $company)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        @can('dashboard_company_blocked_info')
                                                        ...
                                                        @endcan
                                                        @can('dashboard_company_blocked_unblock')
                                                        <a style="padding: 0px 5px;" onclick="return confirm('open access?');" href="{{ route("company.unblock", $company->id) }}" class="btn btn-primary edit-access"><i class="fa-solid fa-unlock"></i></a>
                                                        @endcan
                                                        @can('dashboard_company_blocked_delete')
