        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    ...
                    <!-- /.card-header -->
                    <form action="{{route('member.update', $member->id )}}" method="post" id="quickForm">
                        @method('PUT')
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input  type="email" name="email" class="form-control @if($errors->any() && in_array('email.unique', $errors->all()))  is-invalid @endif" value="{{$member->email}}">
                        ...
                        <input  type="hidden" name="company_id" class="form-control" value="{{$company_id}}" style="display:none;">
                        <input  type="hidden" name="member_id" class="form-control" value="{{$member->id}}" style="display:none;">
                        <!-- /.card-body -->
